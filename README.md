...
| **Humongous Resource.rez** | `.rez` | ✅ | — | — | ✅ | *Backyard Football '10* (Wii): grouped, LZ-compressed resource archive; GX textures (C4 / C8 / RGB5A3 / RGBA8) to PNG, mono DSP-ADPCM sounds to WAV, geometry (type 75) to GLB, THP videos copied out; animation and skinned models not decoded |
