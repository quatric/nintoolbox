...
| **Humongous Resource.rez** | `.rez` | ✅ | — | — | ✅ | *Backyard Football '10* (Wii): grouped, LZ-compressed resource archive; GX textures (C4 / C8 / RGB5A3 / RGBA8) to PNG, mono DSP-ADPCM sounds to WAV, models (type 75) with their object animations (type 86) to textured, animated GLB, THP videos copied out; skinned models and plain data types not decoded |
